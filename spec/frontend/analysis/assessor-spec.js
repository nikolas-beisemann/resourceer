...
describe('assessor', () => {
  ...
  it('shall create summary for timeline', () => {
    ...
    expect(summary.total.timelineAllocated).toBeGreaterThan(280);
    expect(summary.total.timelineAllocated).toBeLessThan(320);
    expect(summary.total.timelineWorkforce).toBeGreaterThan(1.1);
    expect(summary.total.timelineWorkforce).toBeLessThan(1.2);
    expect(summary.total.taskAllocated).toBe(50);
    ...
    expect(summary.curve[0].y).toBe(1);
